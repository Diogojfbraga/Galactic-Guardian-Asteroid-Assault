class BulletSystem {
  ...
  edges(){
      ...
      for(var i=this.bullets.length - 1; i >= 0; i--){  // Looping over the bullets array 
        if(this.bullets[i].y < this.diam / 2){           // Check if each bullet has left the screen
          this.bullets.splice(i, 1);                    // If yes, remove the specific bullet from the array. 
        }
      }
